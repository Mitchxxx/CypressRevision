...
describe('Traversing DOM elements in Cypress',() => {
    ...
    it("children() to get the children of the DOM elements", () => {
    ...
    it("filter() to retrieve elements that match a specific selector", () => {
    ...
    it("prevUntil() to get all previous sibling DOM elements withing elements until other element", () => { 
